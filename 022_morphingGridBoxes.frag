...
//manipulate
  ...
  color += abs(cos(coord.x / 70.0) + sin(coord.y / 70.0) - cos(u_time) * sin(u_time/ 1.)) * 10.;
   color += abs(cos(coord.x / 50.0 ) + sin(coord.y / 50.0) - cos(u_time / 0.4) * sin(u_time/ 0.5)) * 3.;
...
color.r -= 0.1 + length(coord) + 4.;
  ...
  gl_FragColor += vec4(0.7/color + length(coord.x + 900. )/900. * 0.08 + length(coord.y + 900.)/900. * 0.08, 1.);

  //DIAMOND
  //gl_FragColor += vec4(0.1/color + length(coord.x + 650.)/650. * 0.8 + length(coord.y + 650.)/650. * 0.8, 1.);  
